...
/**
 * USIロジック5
 * ・合議タイプが「詰探索エンジンとの合議（「脊尾詰」対応版）」の場合に使う
 * ・「脊尾詰」は詰探索中にstopコマンドを送っても思考を続けるようなので、タイムアウトを設定することにする
 */
public class UsiLogic5 extends UsiLogicCommon {

	/** Logger */
	protected static Logger logger = Logger.getLogger(UsiLogic5.class.getName());
